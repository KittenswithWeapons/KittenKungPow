function createProjectile(name, originEntity) {
    ...
    Projectile.draw = function (context) {
      if (Projectile.heading === -1) {
          ...
          context.scale(-1,1);
          Projectile.animation.drawFrame(deltaTime, context, -this.pos.x, (this.pos.y - Projectile.size.y/2), 1/8);
          context.restore();
       }
       if (Projectile.heading === 1) {
            context.save();
            context.translate(-10, 0);
           Projectile.animation.drawFrame(deltaTime, context, (this.pos.x - Projectile.size.x/2), (this.pos.y - Projectile.size.y/2), 1/8);
           context.restore();
         }
    }
